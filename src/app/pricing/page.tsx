...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Búsqueda avanzada (CNAE, provincia, empleados)",
      "Listas ilimitadas",
      "Info completa (email, web, teléfono, LinkedIn)",
    ],
  },
  {
    id: "business",
...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] bg-grid py-16 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12 animate-in">
          ...
          <p className="text-[#888] text-lg">
            Encuentra el plan perfecto para tu equipo comercial
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {PLANS.map((plan) => (
            <div
              key={plan.id}
              className={`relative bg-[#181818] rounded-2xl p-6 border transition-all glass ${
                plan.popular
        ...
        <section id="contacto" className="mt-16 mb-10 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <form
              ...
              className="space-y-4"
            >
              <input type="hidden" name="_subject" value="Contacto desde OBX Leads — Pricing" />
              <input type="hidden" name="_captcha" value="false" />
              <input type="hidden" name="_next" value="https://leads.obxaistudio.com/pricing?gracias=1" />
